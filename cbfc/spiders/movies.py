...
class MoviesSpider(scrapy.Spider):
    ...
    def __init__(self, from_date='', to_date='', **kwargs):
        ...
        self.start_urls = ["https://www.cbfcindia.gov.in/main/search_page_call.php?title=&lang1=&dt1="+from_date+"&dt2="+to_date]
    ...
    def parse(self, response):
        m_list = json.loads(response.body_as_unicode())["aaData"]
